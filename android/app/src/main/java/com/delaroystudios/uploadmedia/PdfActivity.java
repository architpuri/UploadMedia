...
public class PdfActivity extends AppCompatActivity implements OnPageChangeListener, OnLoadCompleteListener,
    ...
    private void uploadPdf() {
        if (pdfPath == null) {
            ...
            MultipartBody.Part filePart =MultipartBody.Part.createFormData("attachedFile",
                    file.getName(),
                    RequestBody.create(MediaType.parse("application/pdf"),
                    file));
            ApiConfig getResponse = AppConfig.getRetrofit().create(ApiConfig.class);
            Call<ServerResponse> call = getResponse.PdfUploadFunction(filePart);
    ...
    private void uploadFile() {
        if (pdfPath == null) {
            ...
            //map.put("file\"; attachedFile=\"" + file.getName() + "\"", requestBody);
            map.put("Archit",requestBody);
            ApiConfig getResponse = AppConfig.getRetrofit().create(ApiConfig.class);
